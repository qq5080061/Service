...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-15T15:12:14.769Z")

@RestSchema(schemaId = "service")
@RequestMapping(path = "/ccc1115", produces = MediaType.APPLICATION_JSON)
